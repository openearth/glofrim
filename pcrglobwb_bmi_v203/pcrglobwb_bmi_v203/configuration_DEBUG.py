...
class Configuration(object):
    ...
    def __init__(self,config_file_location):							# added 'config_file_location'
        ...
        #parser = optparse.OptionParser(usage=usage)					# commented out
        #(options, arguments) = parser.parse_args()						# commented out
