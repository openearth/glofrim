#!/bin/sh
#PBS -q q1S
#PBS -l select=1:ncpus=1:mpiprocs=4:mem=4000mb
#PBS -N ban_NpthSurge
#source /etc/profile.d/modules.sh
#module load intel-xe-2011.5.220
#set -ax
# =========================================================
...
##### Map & Topography ################
FMAP="${BASE}/map/luxembourg_15min"       # (bangla map) 
