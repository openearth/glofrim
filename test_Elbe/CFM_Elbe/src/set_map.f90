...
! output
      ...
      real,allocatable   ::  grarea(:,:)                 !! drainage area (GRID base)
...
! file
      ...
      character*128      ::  wfile1,  wfile2,  wfile3,  wfile4,  wfile5,  wfile6,wfile7
      parameter             (rfile1='../nextxy.bin')
      parameter             (wfile1='../rivseq.bin')
      parameter             (wfile2='../grarea_grid.bin')
...
!
      do iYY=1, nYY
        ...
        do iXX=1, nXX
          grarea(iXX,iYY)=rgetara(0.,gsize,n_lat,s_lat) 
        end do
      end do
! ===============================================
! clac river sequence
...
print *, 'SET_MAP calc upa drainage area'
      ...
      open(22, file=wfile2, form='unformatted', access='direct', recl=4*nXX*nYY)
      write(22,rec=1) grarea
      close(22)
