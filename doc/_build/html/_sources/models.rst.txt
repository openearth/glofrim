...
A non bmi'ed version of PCR is available at `GitHub <https://github.com/UU-Hydro/PCR-GLOBWB_model>`_ which is, however, not suitable for application within GLOFRIM.
...
WFLOW
-----
WFLOW (hereafter WFL) is less a hydrologic model but a hydrologic modelling platform, currently including the following hydrologic models: SBM, HBV, GR4 and W3RA.
...
For a full documentation of WFL code, models, application, and other functionalities, please visit the `readthedocs <https://wflow.readthedocs.io/en/latest/>`_ page.

**Model availability**

WFL contains a BMI adapter by default and therefore no alternative version has to be applied to use it within GLOFRIM.

All code is available at `GitHub <https://github.com/openstreams/wflow/>`_ and distributed under the GFP version 3.0.
...
To obtain a bmi'ed versoin to be applied within GLOFRIM, please contact the developers.
...
.. note::
    ...
    DFM version higher than 1.1.201 is required to work with GLOFRIM
...
The bmi'ed version of LFP can freely be downloaded from `GitLab <https://gitlab.com/ChippChapp/LISFLOOD-BMI>`_. 
